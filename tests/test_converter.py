...
class TestProgramConverter:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (g.S(0).dagger().dagger(), qml.adjoint(qml.adjoint(qml.S(wires=[0])))),
            (g.T(0), qml.T(wires=[0])),
            (g.T(0).dagger(), qml.adjoint(qml.T(wires=[0]))),
            (g.T(0).dagger().dagger(), qml.adjoint(qml.adjoint(qml.T(wires=[0])))),
            (g.X(0), qml.PauliX(0)),
            (g.X(0).dagger(), qml.adjoint(qml.PauliX(0))),
            (g.X(0).dagger().dagger(), qml.adjoint(qml.adjoint(qml.PauliX(0)))),
            ...
            (
                ...
                qml.adjoint(qml.adjoint(qml.CNOT(wires=[1, 0]))),
            ),
            ...
            (
                ...
                qml.adjoint(qml.adjoint(qml.Toffoli(wires=[2, 1, 0]))),
            ),
            (g.Y(0), qml.PauliY(0)),
            (g.Y(0).dagger(), qml.adjoint(qml.PauliY(0))),
            (g.Y(0).dagger().dagger(), qml.adjoint(qml.adjoint(qml.PauliY(0)))),
            (g.Z(0), qml.PauliZ(0)),
            (g.Z(0).dagger(), qml.adjoint(qml.PauliZ(0))),
            (g.Z(0).dagger().dagger(), qml.adjoint(qml.adjoint(qml.PauliZ(0)))),
            ...
            (
                ...
                qml.adjoint(qml.adjoint(qml.CZ(wires=[1, 0]))),
            ),
            (g.CNOT(0, 1), qml.CNOT(wires=[0, 1])),
            (g.CNOT(0, 1).dagger(), qml.adjoint(qml.CNOT(wires=[0, 1]))),
            (g.CNOT(0, 1).dagger().dagger(), qml.adjoint(qml.adjoint(qml.CNOT(wires=[0, 1])))),
            ...
            (
                ...
                qml.adjoint(qml.adjoint(qml.Toffoli(wires=[2, 0, 1]))),
            ),
            (g.SWAP(0, 1), qml.SWAP(wires=[0, 1])),
            (g.SWAP(0, 1).dagger(), qml.adjoint(qml.SWAP(wires=[0, 1]))),
            (g.SWAP(0, 1).dagger().dagger(), qml.adjoint(qml.adjoint(qml.SWAP(wires=[0, 1])))),
            ...
            (
                ...
                qml.adjoint(qml.adjoint(qml.CSWAP(wires=[2, 0, 1]))),
            ),
            (g.ISWAP(0, 1), qml.ISWAP(wires=[0, 1])),
            (g.ISWAP(0, 1).dagger(), qml.adjoint(qml.ISWAP(wires=[0, 1]))),
            (g.ISWAP(0, 1).dagger().dagger(), qml.adjoint(qml.adjoint(qml.ISWAP(wires=[0, 1])))),
            ...
            (
                ...
                qml.adjoint(qml.adjoint(qml.PSWAP(0.3, wires=[0, 1]))),
            ),
            (g.CZ(0, 1), qml.CZ(wires=[0, 1])),
            (g.CZ(0, 1).dagger(), qml.adjoint(qml.CZ(wires=[0, 1]))),
            (g.CZ(0, 1).dagger().dagger(), qml.adjoint(qml.adjoint(qml.CZ(wires=[0, 1])))),
            ...
            (
                ...
                qml.adjoint(qml.adjoint(qml.PhaseShift(0.3, wires=[0]))),
            ),
            ...
            (
                ...
                qml.adjoint(qml.adjoint(plf.ops.CPHASE(0.3, 3, wires=[1, 0]))),
            ),
            (g.RX(0.3, 0), qml.RX(0.3, wires=[0])),
            (g.RX(0.3, 0).dagger(), qml.adjoint(qml.RX(0.3, wires=[0]))),
            (g.RX(0.3, 0).dagger().dagger(), qml.adjoint(qml.adjoint(qml.RX(0.3, wires=[0])))),
            ...
            (
                ...
                qml.adjoint(qml.adjoint(qml.CRX(0.3, wires=[1, 0]))),
            ),
            (g.RY(0.3, 0), qml.RY(0.3, wires=[0])),
            (g.RY(0.3, 0).dagger(), qml.adjoint(qml.RY(0.3, wires=[0]))),
            (g.RY(0.3, 0).dagger().dagger(), qml.adjoint(qml.adjoint(qml.RY(0.3, wires=[0])))),
            ...
            (
                ...
                qml.adjoint(qml.adjoint(qml.CRY(0.3, wires=[1, 0]))),
            ),
            (g.RZ(0.3, 0), qml.RZ(0.3, wires=[0])),
            (g.RZ(0.3, 0).dagger(), qml.adjoint(qml.RZ(0.3, wires=[0]))),
            (g.RZ(0.3, 0).dagger().dagger(), qml.adjoint(qml.adjoint(qml.RZ(0.3, wires=[0])))),
            ...
            (
                ...
                qml.adjoint(qml.adjoint(qml.CRZ(0.3, wires=[1, 0]))),
            ),
            ...
            (
                ...
                qml.adjoint(qml.adjoint(plf.ops.CPHASE(0.3, 3, wires=[0, 1]))),
            ),
            ...
            (
                ...
                qml.adjoint(qml.adjoint(plf.ops.CPHASE(0.3, 0, wires=[0, 1]))),
            ),
            ...
            (
                ...
                qml.adjoint(qml.adjoint(plf.ops.CPHASE(0.3, 1, wires=[0, 1]))),
            ),
